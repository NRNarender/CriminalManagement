...
class Criminal:
    def __init__(self, root):
        ...
        # Criminal NO
        lbl_criminal_no = Label(upper_frame, font=('arial', 12, 'bold'), text="Criminal ID:", bg='white')
        lbl_criminal_no.grid(row=0, column=2, sticky=W, padx=2, pady=7)

        txt_criminal_no = ttk.Entry(upper_frame, textvariable=self.var_criminal_id, width=22, font=('arial', 11, 'bold'))
        ...
        combo_search_box['values'] = ('Select Option', 'Case_id', 'Criminal_id')
        ...
        crimeagency = Label(search_frame, font=("arial", 20, "bold"), text="SEARCH FOR SOME SPECIFIC CRIMINAL", bg='white', fg='crimson')
        ...
        self.criminal_table.heading("2", text="Crime Id")
        ...
        if self.var_case_id.get() == "":
            ...
            try:
                ...
                if update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute('update criminal set Criminal_id=%s, Criminal_name=%s, Nick_name=%s, arrest_date=%s, dateOfcrime=%s, address=%s, age=%s, occupation=%s, BirthMark=%s, crimeType=%s, fatherName=%s, gender=%s, wanted=%s where Case_id=%s', (
                        self.var_criminal_id.get(),
                        self.var_name.get(),
                        self.var_nickname.get(),
                        self.var_arrest_date.get(),
